...
function PopWindow()
{
window.open('lista_cli_aux2.php','win','width=460,height=400,menubar=no,scrollbars=yes,toolbar=no,location=no,directories=no,resizable=no,top=100,left=600');
}
...
<?php
echo"<td ALIGN=CENTER width='50%' bgcolor='#FFFFFF'><A href='ver_venta.php?cod_fac=$cod_fac' class='linktab2' title=''>DETALLE VENTA</A></td>";
?>
<td bgcolor="#5E8CB5" width="50%"><font color="#ffffff" size="2" face="Courier New, Courier, mono"><b>MODIFICAR VENTA</b></font></td>
</tr>
</table>

<FORM METHOD="get" NAME="form1" ACTION="mod_venta.php">
...
<TR> 
   ...
   <td colspan="2"><INPUT TYPE="text" NAME="cod_cli"  value="<?php echo $cod_cli; ?>" SIZE="1" MAXLENGTH="5" readonly>&nbsp;<INPUT TYPE="text" NAME="nom_cli"  value="<?php echo $nom_cli; ?>" SIZE="33" MAXLENGTH="50" readonly><img src="../img/b_lista.gif" onclick="JavaScript:PopWindow()" title="Seleccionar de Lista"></td>
</TR> 
<TR> 
...
<?php
    ...
    echo"<td><INPUT TYPE=text NAME=bul SIZE=10 value=0.00 align=right readonly></font></td>";		 
    echo"<td><INPUT TYPE=text NAME=cant SIZE=10 MAXLENGTH=10 value=0.00 align=right readonly></td>";
    echo"<td><INPUT TYPE=text NAME=cos SIZE=10 MAXLENGTH=10 value=0.00 align=right readonly></td>";
    echo"<td><INPUT TYPE=text NAME=imp SIZE=10 MAXLENGTH=10 value=0.00 align=right readonly></td>";
    echo"</tr>";
?>
<tr><td>&nbsp;</td></tr>
<tr>
<td bgcolor="#ffffff" width="33%" colspan="6"><font color="#5E8CB5" size="2" face="Courier New, Courier, mono"><b><? echo"$limit"; ?> ARTICULOS</td>
</tr>
</table>
<?php
/////////////////////////////////////////ini/////////////////////////////////////////
...
";
echo"
<form method=get action=ver_venta.php>
<TD>
