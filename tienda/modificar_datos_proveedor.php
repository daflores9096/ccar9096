...
$result=mysqli_query($link,"SELECT * FROM proveedor WHERE cod_pro='$cod_pro'");
...
<TR> 
   ...
   <td colspan="2"><INPUT TYPE="text" NAME="nom_pro" SIZE="40" MAXLENGTH="50" value="<?php echo"$row[1]"; ?>"></td>
</TR> 
<TR> 
...
<TR> 
   ...
   <TD colspan="2"><INPUT TYPE="text" NAME="dire_pro" SIZE="40" MAXLENGTH="50" value="<?php echo"$row[3]"; ?>"></TD>
</TR> 
<TR> 
...
<TR> 
   ...
   <TD colspan="2"><INPUT TYPE="text" NAME="ciudad_pro" SIZE="40" MAXLENGTH="40" value="<?php echo"$row[4]"; ?>"></TD>
</TR> 
<TR> 
   <TD bgcolor="#FFFFFF"><b><font size="2" color="#5e8cb5">TELEFONO:</TD> 
   <TD><INPUT TYPE="text" NAME="tel_pro" SIZE="15" MAXLENGTH="20" value="<?php echo"$row[5]"; ?>"></TD>
</TR>
<TR> 
   <TD bgcolor="#FFFFFF"><b><font size="2" color="#5e8cb5">TELEFONO SEC:</TD> 
   <TD><INPUT TYPE="text" NAME="tel_sec" SIZE="15" MAXLENGTH="20" value="<?php echo"$row[6]"; ?>"></TD>
</TR>
<TR>
   <TD bgcolor="#FFFFFF"><b><font size="2" color="#5e8cb5">E-MAIL:</TD> 
   <TD><INPUT TYPE="text" NAME="email_pro" SIZE="40" MAXLENGTH="40" value="<?php echo"$row[7]"; ?>"></TD>
...
<TR> 
   ...
   <TD colspan="2"><TEXTAREA COLS=30 ROWS=5 NAME="desc_pro"><?php echo"$row[8]"; ?></TEXTAREA> </TD>
</TR> 
</TABLE>
<!-- form fin -->
<br>
<br> 
<table align="center">
	<INPUT TYPE="hidden" NAME="ide" VALUE="<?php echo"$cod_pro"; ?>">
<TR >
