...
function PopWindow()
{
window.open('lista_pro_aux.php','win','width=460,height=400,menubar=no,scrollbars=yes,toolbar=no,location=no,directories=no,resizable=no,top=100,left=600');
}
</script>
<script> 
...
<form method="post" action="showall_compras.php">
...
<td bgcolor="#5E8CB5" width="33%"><font color="ffffff" size="2" face="Courier New, Courier, mono"><b>NUEVA COMPRA</td>
</tr>
</table>
...
<br>
<!-- form inicio -->
<FORM name="form2" ACTION="generar_factura.php" method="get"> 
...
<TR> 
   ...
   <td colspan="2"><INPUT TYPE="text" NAME="cod_pro" SIZE="1" MAXLENGTH="5">&nbsp;<INPUT TYPE="text" NAME="nom_pro" SIZE="33" MAXLENGTH="50"><img src="../img/b_lista.gif" onclick="JavaScript:PopWindow()" title="Seleccionar de Lista"></td>
</TR> 
</TABLE>
<!-- form fin -->
<br>
...
<TR >
	...
	<td width="10%">&nbsp;</td>
	<form action="showall_compras.php" method="post">
