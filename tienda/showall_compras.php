...
<tr>
<td width="80%"><font color="#5E8CB5" size="2"><b>LISTA DE COMPRAS</b></font></td>
...
<?php
    echo"<td bgcolor='#5E8CB5' width='33%'><font color='ffffff' size='2' face='Courier New, Courier, mono'><b>MOSTRAR COMPRAS</td>";
    if ($_SESSION['nivel_acceso'] == '1'){//restringir anular compra
    echo"<td width='33%'><A href='anular_compra.php' class='linktab2' title=''>ANULAR COMPRAS</A></td>";
    } else {
...
/////////////////////icono de funcion////////////////////////
		 $id=$var_envio;
		 printf("<td align=center><a href=\"$pag_proceso?$id=%s\"><IMG SRC=$icono BORDER=0 title='Mostrar detalle de compra'></a></td>
			  ", $row[$id], $row[$id]);
/////////////////////////////////////////////
   	     echo"</tr>";
         $cont=$cont+1;
