...
<TR> 
   ...
   <TD colspan="2"><INPUT TYPE="text" NAME="cod_item" SIZE="15" MAXLENGTH="10" <? echo"value=$row[0]" ?>></TD> 
</TR>
<TR> 
   <TD bgcolor="#FFFFFF"><b><font size="2" color="#5e8cb5">NOMBRE ARTICULO:</TD> 
   <td colspan="2"><INPUT TYPE="text" NAME="nom_item" SIZE="50" MAXLENGTH="50" <? echo"value='$row[1]'" ?>></td>
</TR> 
<TR> 
   <TD bgcolor="#FFFFFF"><b><font size="2" color="#5e8cb5">UNIDAD:</TD> 
   <td colspan="2"><INPUT TYPE="text" NAME="unid_item" SIZE="15" MAXLENGTH="20" <? echo"value=$row[2]" ?>></td>
</TR> 
<TR> 
   <TD bgcolor="#FFFFFF"><b><font size="2" color="#5e8cb5">PRECIO:</TD> 
   <TD colspan="2"><INPUT TYPE="text" NAME="precio_item" SIZE="15" MAXLENGTH="10" <? echo"value=$row[3]" ?> align="right"></TD> 
</TR> 
<TR> 
   <TD bgcolor="#FFFFFF"><b><font size="2" color="#5e8cb5">CANTIDAD POR CAJA:</TD> 
   <TD colspan="2"><INPUT TYPE="text" NAME="caja_item" SIZE="15" MAXLENGTH="10" <? echo"value=$row[4]" ?> align="right"></TD> 
</TR> 
<TR> 
...
<TR> 
   ...
   <TD colspan="2"><INPUT TYPE="text" NAME="existencia" SIZE="15" MAXLENGTH="10" <? echo"value=$row[6]" ?> align="right"></TD> 
</TR> 
<TR> 
   <TD bgcolor="#FFFFFF"><b><font size="2" color="#5e8cb5">Existencia Maxima:</TD> 
   <TD><INPUT TYPE="text" NAME="exi_max" SIZE="15" MAXLENGTH="10" <? echo"value=$row[5]" ?> align="right"></TD> 
</TR>
<TR>
   <TD bgcolor="#FFFFFF"><b><font size="2" color="#5e8cb5">Existencia Minima:</TD> 
   <TD><INPUT TYPE="text" NAME="exi_min" SIZE="15" MAXLENGTH="10" <? echo"value=$row[7]" ?> align="right"></TD> 
...
<TR> 
   ...
   <TD colspan="2"><TEXTAREA COLS=30 ROWS=5 NAME="deta_item"><? echo"$row[8]" ?></TEXTAREA> </TD> 
</TR> 
</TABLE>
<!-- form fin -->
<br>
...
<table align="center">
<TR >
    <input type="hidden" name="ide" value=<? echo"$row[0]";?>>
