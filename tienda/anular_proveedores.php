...
<tr>
<td width="80%"><font color="#5E8CB5" size="2"><b>ANULAR PROVEEDOR</b></font></td>
...
<input type="submit" name="enviar" value="NUEVO PROVEEDOR" class="boton">
</form>
</td>
</tr>
</table>
...
<tr>
<?php
    echo"<td bgcolor='#ffffff' width='50%' colspan='3'><A href='showall_proveedores.php' class='linktab'><font color='5E8CB5' size='2' face='Courier New, Courier, mono'><b>&nbsp;Mostrar Proveedores</a></td>";
    echo"<td bgcolor='#5e8cb5' width='50%' colspan='3'><font color='ffffff' size='2' face='Courier New, Courier, mono'><b>&nbsp;Anular Proveedores</td>";
?>
</tr>
</table>
...
$tabla="proveedor";
$orderby="nom_pro";
$arr_campos=array("cod_pro","nom_pro","tel_pro","dire_pro");
...
$var_envio="cod_pro";
$pag_proceso="eliminar_proveedor.php";
$icono="../img/boton_borrar.png";
$funcion="";
$pag_ini="showall_proveedores.php";
$tam_pag=50;
...
/////////////////////icono de funcion////////////////////////
		 $id=$var_envio;
		 printf("<td align=center bgcolor=FBD9D9><a href=\"$pag_proceso?$id=%s\"><IMG SRC=$icono BORDER=0 title='Eliminar Proveedor'></a></td>
			  ", $row[$id], $row[$id]);
/////////////////////////////////////////////
   	     echo"</tr>";
	   }
