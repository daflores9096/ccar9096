...
$var_envio="cod_cli";
$pag_proceso="eliminar_cliente.php";
$icono="../img/boton_borrar.png";
$funcion="";
$pag_ini="anular_clientes.php";
$tam_pag=50;
?> 
<?=body_container_ini("","770","0")?>
<table align="right" bgcolor="#e1e4f2" width="100%">
<tr>
<td width="80%"><font color="#5E8CB5" size="2"><b>ANULAR CLIENTES</b></b></font></td>
...
<tr>
<td bgcolor="#ffffff" width="50%" colspan="3"><A href="showall_clientes.php" class="linktab"><font color="5E8CB5" size="2" face="Courier New, Courier, mono"><b>&nbsp;Mostrar Clientes</a></td>
<td bgcolor="#5e8cb5" width="50%" colspan="3"><font color="ffffff" size="2" face="Courier New, Courier, mono"><b>&nbsp;Anular Clientes</td>
</tr>
</table>
...
/////////////////////icono de funcion////////////////////////
		 $id=$var_envio;
		 printf("<td align=center><a href=\"$pag_proceso?$id=%s\"><IMG SRC=$icono BORDER=0 title='Anular Cliente'></a></td>
			  ", $row[$id], $row[$id]);
/////////////////////////////////////////////
   	     echo"</tr>";
	   }
