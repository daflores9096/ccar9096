...
echo"<br><br><br><br>";
?>
<?=container_mensaje(" Restaurar base de datos DESDE DISCO:
<br><br>
<table align=center cellpadding=0 cellspacing=0 width=100%>
	<FORM ENCTYPE='multipart/form-data' ACTION='backup_restaurar2.php' METHOD='post'>
<tr>
	<td bgcolor='#ebf3f7'>
...
echo"<br><br><br><br>";
?>
<?=container_mensaje("Crear respaldo EN DISCO
<br>
<table>
<tr>
	<td>
	<FORM NAME=form1 ACTION='backup_crear2.php' METHOD='get'>
	</td>
</tr>
<tr>
