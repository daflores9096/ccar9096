...
<tr>
<td width="80%"><font color="#5E8CB5" size="2"><b>ANULAR VENTAS</b></font></td>
...
<?php
    echo"<td width='33%'><A href='showall_ventas.php' class='linktab2' title='Muestra todas las Salidas registradas'>MOSTRAR VENTAS</A></td>";
    echo"<td bgcolor='#5E8CB5' width='33%'><font color='ffffff' size='2' face='Courier New, Courier, mono'><b>ANULAR VENTAS</td>";
?>
</tr>
</table>
...
/////////////////////icono de funcion////////////////////////
		 $id=$var_envio;
		 printf("<td align=center bgcolor=FBD9D9><a href=\"$pag_proceso?$id=%s\"><IMG SRC=$icono BORDER=0 title='Anular venta'></a></td>
			  ", $row[$id], $row[$id]);
/////////////////////////////////////////////
   	     echo"</tr>";
         $cont=$cont+1;
