...
$tabla="item";
$order_by="cod_item";
$arr_campos=array("cod_item","nom_item","unid_item","caja_item","existencia");
$arr_titulos=array("CODIGO","ARTICULO","UNIDAD","C.CAJA","EXISTENCIA");
$arr_color_tabla=array("5e8cb5","ffffff","ffffff","5e8cb5");
$arr_color_texto=array("ffffff","000000","c4b6ff");
$var_envio1="cod_item";
$var_envio2="nom_item";
$var_envio3="unid_item";
$var_envio4="precio_item";
$pag_proceso="nueva_venta.php";
$icono="../img/ingreso.png";
$funcion="";
$pag_ini="lista_item.php";
$tam_pag=1000;
...
//////reconocer insumos escasos///////
	       ...
	       echo"<td align=$lado><font size=1 color=red>$row[$cam]</font></td>";
		   }else if(($cam=="existencia") && ($row['existencia']>=$row['exi_max'])){
	       echo"<td align=$lado><font size=1 color=green>$row[$cam]</font></td>";
...
//		 $id=$var_envio;
		 ...
		 $id3=$var_envio3;
		 $id4=$var_envio4;
		 $aux1=str_replace(" ", "&nbsp;", $row[$id1]);
		 $aux2=str_replace(" ", "&nbsp;", $row[$id2]);
		 $aux3=str_replace(" ", "&nbsp;", $row[$id3]);
		 $aux4=$row[$id4];
		 echo"<td><a href=JavaScript:close(); title=pasar_valor onClick=window.opener.document.form1.cod.value='$aux1';window.opener.document.form1.nom.value='$aux2';window.opener.document.form1.cos.value='$aux4';><IMG SRC=$icono BORDER=0 title='Seleccionar Cliente' width=15 height=15></a></td>";
/////////////////////////////////////////////
   	     echo"</tr>";
	   }
