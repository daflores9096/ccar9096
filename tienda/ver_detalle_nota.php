...
$get1=mysql_query("SELECT cod_item FROM venta_aux WHERE cod_fac='$cod_fac'",$link);
}
...
<? if($tipo=='C'){ ?>
stm_aix("p0i1","p0i0",[0,"   << Atras   ","","",-1,-1,0,"ver_movimiento_pro.php?cod_pro=<? echo $cod_pro ?>"]);
...
stm_aix("p1i0","p0i0",[0,"Nota de Venta","","",-1,-1,0,"print_nota_compra.php?cod_fac=<? echo $cod_fac ?>","_blank","","","","",0,0,0,"","",0,0,0,0,1,"#ffffff",0,"#ffffff",0,"","",3,3,0,0,"#FFFFF7","#000000","#5e8cb5","#F3AC6C","8pt 'Tahoma','Arial'","8pt 'Tahoma','Arial'"]);

<? }else{ ?>
stm_aix("p0i1","p0i0",[0,"   << Atras   ","","",-1,-1,0,"ver_movimiento_cli.php?cod_cli=<? echo $cod_pro ?>"]);
stm_aix("p0i2","p0i0",[0,"Imprimir","","",-1,-1,0,"","_self","","","","",0,0,0,"arrow_r.gif","arrow_r.gif",7,7]);
stm_bpx("p1","p0",[1,4,0,0,3,4,0,0,100,"",-2,"",-2,90,0,0,"#000000","#F1F2EE"]);
...
?>   
   ...
   <td colspan="2"><INPUT TYPE="text" NAME="cod_cli" SIZE="1" MAXLENGTH="5" value="<? echo"$cod_pro"; ?>" readonly>&nbsp;<INPUT TYPE="text" NAME="nom_pro" SIZE="33" MAXLENGTH="50" value="<? echo"$nom_pro"; ?>" readonly></td>
<?
}
?>
</TR> 
