...
<tr>
<td width="80%"><font color="#5E8CB5" size="2"><b>INVENTARIO FISICO > Anular Inventario</b></font></td>
...
<td align="right" width="10%">
<form method="post" action="../tienda/nuevo_inventario.php">
<input type="submit" name="enviar" value="NUEVO INVENTARIO" class="boton">
</form>
</td>
</tr>
</table>
...
<tr>
<?php
    echo"<td bgcolor='#ffffff' width='50%' colspan='3'><A href='showall_inventarios.php' class='linktab'><font color='5E8CB5' size='2' face='Courier New, Courier, mono'><b>&nbsp;Mostrar Inventarios</a></td>";
    echo"<td bgcolor='#5e8cb5' width='50%' colspan='3'><font color='ffffff' size='2' face='Courier New, Courier, mono'><b>&nbsp;Anular Inventarios</td>";
?>
</tr>
</table>
...
$var_envio="id_inv";
$pag_proceso="eliminar_inventario.php";
$icono="../img/boton_borrar.png";
$funcion="";
$pag_ini="anular_inventarios.php";
$tam_pag=50;
...
//////reconocer insumos escasos///////
	       ...
	       echo"<td><font size=2 color=red>$row[$cam]</font></td>";
		   }else { echo"<td><font size=2 color=5e8cb5>$row[$cam]</font></td>";}
	     }
/////////////////////icono de funcion////////////////////////
		 $id=$var_envio;
		 printf("<td align=center bgcolor=FBD9D9><a href=\"$pag_proceso?$id=%s\"><IMG SRC=$icono BORDER=0 title='Anular Inventario'></a></td>
			  ", $row[$id], $row[$id]);
/////////////////////////////////////////////
   	     echo"</tr>";
	   }
