...
stm_ai("p0i0",[0,"Volver a lista clientes","","",-1,-1,0,"showall_clientes.php","_self","","","","",0,0,0,"","",0,0,0,0,1,"#ffffff",0,"#ffffff",0,"","",3,3,0,0,"#FFFFF7","#000000","#5e8cb5","#F3AC6C","bold 8pt 'Tahoma','Arial'","bold 8pt 'Tahoma','Arial'",0,0]);
...
//    echo"<td width='20%'><A href='ver_ficha_item.php?cod_insum=$indcom' class='linktab'>GENERAL</A></td>";
    echo"<td width='50%'><A href='ver_ficha_cliente.php?cod_cli=$indcom' class='linktab'>DATOS CLIENTE</A></td>";
    echo"<td bgcolor='#5E8CB5' width='50%'><font color='ffffff' size='2' face='Courier New, Courier, mono'><b>MOVIMIENTO CLIENTE</td>";
?>
</tr>
</table>
...
<tr>
<td><font color=#5e8cb5 size=3><b>Total ventas realizadas:</b></font></td>
<td align=right><font color=#5e8cb5 size=3>$ US <b>$total_ventas</b></font></td>
</tr>
</table>
";
?>
