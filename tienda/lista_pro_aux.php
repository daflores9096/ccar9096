...
/////////////////////icono de funcion////////////////////////
		 ...
		 echo"<td><a href=JavaScript:close(); title=pasar_valor onClick=window.opener.document.form2.cod_pro.value=$row[$id];window.opener.document.form2.nom_pro.value='$aux';window.opener.document.form2.contacto_sec.value='$aux1';><IMG SRC=$icono BORDER=0 title='Seleccionar Proveedor' width=15 height=15></a></td>";
/////////////////////////////////////////////
   	     echo"</tr>";
	   }
