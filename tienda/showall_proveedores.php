...
<tr>
<?php
    echo"<td bgcolor='#5e8cb5' width='50%' colspan='3'><font color='ffffff' size='2' face='Courier New, Courier, mono'><b>&nbsp;Mostrar Proveedores</td>";
    echo"<td bgcolor='#ffffff' width='50%' colspan='3'><A href='anular_proveedores.php' class='linktab'><font color='5E8CB5' size='2' face='Courier New, Courier, mono'><b>&nbsp;Anular Proveedores</a></td>";
?>
</tr>
</table>
...
$var_envio="cod_pro";
$pag_proceso="modificar_datos_proveedor.php";
...
/////////////////////icono de funcion////////////////////////
		 $id=$var_envio;
		 printf("<td align=center><a href=\"$pag_proceso?$id=%s\"><IMG SRC=$icono BORDER=0 title='Ver detalle proveedor'></a></td>
			  ", $row[$id], $row[$id]);
/////////////////////////////////////////////
   	     echo"</tr>";
	   }
