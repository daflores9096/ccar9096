...
$tabla="item";
$orderby="cod_item";
$arr_campos=array("cod_item","nom_item","unid_item","precio_item","caja_item");
$arr_titulos=array("CODIGO","ITEM","UNIDAD","PRECIO UNIT.","CANT. CAJA");
...
<tr><td><b>LISTA DE ARTICULOS DISPONIBLES (SP)</b></td></tr>
</table>
";
...
//llamada a base de datos
	$get = mysqli_query($link,'select * from '.$tabla.' where existencia>0 order by '.$orderby.' '.$orden.' limit '.$st.','.$pp);
	echo"<TABLE border=1 CELLSPACING=0 CELLPADDING=0 align=center width=90% bgcolor=$arr_color_tabla[2] rules=rows frame=hsides bordercolor=#000000>
	 ...
	 $campo=$arr_campos[$c];
	   if(($arr_campos[$c]=='precio_item')||($arr_campos[$c]=='caja_item')){
...
//////reconocer insumos escasos///////
	       ...
	       echo"<td align=$lado><font size=2 color=#000000>$row[$cam]</font></td>";
