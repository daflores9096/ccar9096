...
echo '
	...
	<tr>
	    <td colspan="2" align="center"><input type="Submit" value="[ IR A MES ]"></td>
	</tr>
	</table><br>
...
/*
    ...
    <a href="" onclick="muestraCalendario(\''. $raiz.'\',\''. $nombreformulario .'\',\''.$nombrecampo.'\')"><img src="../img/b_calendar.png" border="0" title="Calendario"></a>	
	';	
*/

  echo '
   <INPUT name="'.$nombrecampo.'" size="10" value="'.$fecha.'">
   <input TYPE=button value="<" onclick="muestraCalendario(\''. $raiz.'\',\''. $nombreformulario .'\',\''.$nombrecampo.'\')" title="Calendario">
   '; 
