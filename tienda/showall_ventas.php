...
<tr>
<td width="80%"><font color="#5E8CB5" size="2"><b>LISTA DE VENTAS</b></font></td>
...
<td align="right" width="10%">
<form method="post" action="nueva_venta2.php">
<input type="submit" name="enviar" value="NUEVA VENTA" class="boton">
</form>
</td>
</tr>
</table>
...
<?php
    echo"<td bgcolor='#5E8CB5' width='33%'><font color='ffffff' size='2' face='Courier New, Courier, mono'><b>MOSTRAR VENTAS</td>";
    if ($_SESSION['nivel_acceso'] == '1'){//restringir anular venta
    echo"<td width='33%'><A href='anular_venta.php' class='linktab2' title=''>ANULAR VENTAS</A></td>";
    } else {
        //no mostrar la pesta�a de anular
    }
?>
</tr>
</table>
...
<tr>
<td bgcolor="#ffffff" width="30%" colspan="3"><font color="5E8CB5" size="2" face="Courier New, Courier, mono"><b>&nbsp;LISTA DE VENTAS:</td>
<td width=70%>&nbsp;</td>
</tr>
</table>
<!-- inicio -->
...
/////////////////////icono de funcion////////////////////////
		 $id=$var_envio;
		 printf("<td align=center><a href=\"$pag_proceso?$id=%s\"><IMG SRC=$icono BORDER=0 title='Mostrar detalle de venta'></a></td>
			  ", $row[$id], $row[$id]);
/////////////////////////////////////////////
   	     echo"</tr>";
         $cont=$cont+1;
