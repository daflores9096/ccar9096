...
stm_aix("p1i0","p0i0",[0,"Reporte de ventas","","",-1,-1,0,"print_rep_ventas.php?fecha_min=<? echo $fechamin; ?>&fecha_max=<? echo $fechamax; ?>","_blank","","","","",0,0,0,"","",0,0,0,0,1,"#ffffff",0,"#ffffff",0,"","",3,3,0,0,"#FFFFF7","#000000","#5e8cb5","#F3AC6C","8pt 'Tahoma','Arial'","8pt 'Tahoma','Arial'"]);
stm_ep();
stm_ep();
stm_em();
//-->
...
<tr>
<td bgcolor="#ffffff" width="60%" colspan="3">&nbsp<? echo"<font color=5e8cb5 size=2>REPORTE DE VENTAS del dia <b>$fechamin</b> al dia <b>$fechamax</b></b></font>"; ?></td>
<td width=40%>&nbsp;</td>
</tr>
</table>
<br>
