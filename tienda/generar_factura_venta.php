...
<form method="post" action="../tienda/nueva_venta.php">
...
<td bgcolor="#5E8CB5" width="33%"><font color="ffffff" size="2" face="Courier New, Courier, mono"><b>NOTA DE VENTA</td>
</tr>
</table>
...
<td bgcolor="e1e4f2">
<br>
<form method="get" name="form1" action="chk_venta.php">
<br>
<TABLE border="0" cellpadding="1" cellspacing="2" width="70%"> 
<TR> 
   <TD bgcolor="#FFFFFF"><b><font size="2" color="#5e8cb5">Nº VENTA:</TD> 
   <td colspan="2"><INPUT TYPE="text" NAME="cod_fac" SIZE="10" MAXLENGTH="10" value="<? echo"$cod_fac"; ?>" readonly style="background-color:#FFFFFF "></td>
</TR> 
<TR> 
   <TD bgcolor="#FFFFFF"><b><font size="2" color="#5e8cb5">FECHA:</TD> 
   <td colspan="2"><INPUT TYPE="text" NAME="fecha_fac" SIZE="10" MAXLENGTH="10" value="<? echo"$fecha_fac"; ?>" readonly style="background-color:#FFFFFF "></td>
</TR> 
<TR> 
