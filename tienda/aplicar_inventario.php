...
<td width="33%"><A href="inventario_pen.php?id_inv=<?php echo"$id_inv";?>&fecha_lev=<?php echo"$fecha_lev";?>&descripcion=<?php echo"$descripcion";?>" class="linktab">INVENTARIO PENDIENTE</A></td>
...
<br><center>
<INPUT TYPE="hidden" NAME="numreg" value="<?php echo $numreg; ?>">
