...
/////////////////////icono de funcion////////////////////////
		 ...
		 echo"<td><a href=JavaScript:close(); title=pasar_valor onClick=window.opener.document.form2.cod_cli.value=$row[$id];window.opener.document.form2.nom_cli.value='$aux';><IMG SRC=$icono BORDER=0 title='Seleccionar Cliente' width=15 height=15></a></td>";
/////////////////////////////////////////////
   	     echo"</tr>";
	   }
