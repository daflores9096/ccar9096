...
$tabla="proveedor";
$order_by="nom_pro";
$arr_campos=array("cod_pro","nom_pro","contacto_sec");
$arr_titulos=array("CODIGO","CLIENTE","CONTACTO");
$arr_color_tabla=array("5e8cb5","ffffff","ffffff","5e8cb5");
$arr_color_texto=array("ffffff","000000","c4b6ff");
$var_envio="cod_pro";
$var_envio1="nom_pro";
$var_envio2="contacto_sec";
$pag_proceso="nueva_compra.php";
$icono="../img/ingreso.png";
$funcion="";
$pag_ini="lista_pro_aux.php";
$tam_pag=100;
?> 
<!-- inicio -->
<?php
...
/////////////////////icono de funcion////////////////////////
		 ...
		 echo"<td><a href=JavaScript:close(); title=pasar_valor onClick=window.opener.document.form1.cod_pro.value=$row[$id];window.opener.document.form1.nom_pro.value='$aux';window.opener.document.form1.contacto_sec.value='$aux1';><IMG SRC=$icono BORDER=0 title='Seleccionar Proveedor' width=15 height=15></a></td>";
/////////////////////////////////////////////
   	     echo"</tr>";
	   }
